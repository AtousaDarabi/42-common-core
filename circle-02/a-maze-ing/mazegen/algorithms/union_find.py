...
class UnionFind:
    ...
    @details Used to keep track of connected components to prevent
             cycles during maze generation.
    """
    ...
    def find(self, i: int) -> int:
        """!
        @brief Finds the representative of the set containing i, with
               path compression.
    ...
    def union(self, i: int, j: int) -> bool:
        ...
        @return True if they were in different sets and are now merged,
                False otherwise.
        """
